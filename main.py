...
PAGE_1_BBOXES = [
    [462.0, 124.7, 555.6, 246.6],  # 반/번호/담임성명 영역
    [266.2, 189.9, 447.9, 246.6],  # 사진 영역
    [121.9, 280.6, 558.4, 328.8],  # 성명, 성별, 주민등록번호, 주소 영역
    [82.2, 337.3, 388.3, 365.7],   # 학적사항 영역
]

# 모든 페이지에 공통으로 적용될 마스킹 영역
ALL_PAGES_BBOXES = [
    [28.3, 776.7, 277.8, 807.9],   # 모든 페이지 맨하단 고등학교이름 영역
    [334.5, 776.7, 566.9, 839.1],  # 모든 페이지 맨하단 반/번호/성명 영역
]
